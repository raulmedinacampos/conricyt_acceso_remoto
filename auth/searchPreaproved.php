...
if($institucion == 475 && $cuenta) {
	$query = "SELECT id, firstname, lastname1, lastname2, rfc, entidad, gender, inst_email, comm_email, deleg_imss, clave_est_org, unit_faculty FROM preaprobado WHERE account_num = '$cuenta'";
